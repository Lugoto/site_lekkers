...
if (!empty($_POST['prenom'])&&!empty($_POST['nom'])&&!empty($_POST['mail'])&&!empty($_POST['sujet'])&&!empty($_POST['message'])){
  ...
  <button class="btn waves-effect waves-light red darken-4 btnchercher" id="submitButton" type="submit" name="action" value="submit" onclick="history.go(-1)">Retour au formulaire</button>
